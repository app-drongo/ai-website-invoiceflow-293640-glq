...
const DEFAULT_HERO = {
  ...
  titleHighlight: 'smart invoicing',
  description:
    'Create, send, and track professional invoices in minutes. Built specifically for small businesses who need to get paid faster and manage cash flow better.',
  features: [
