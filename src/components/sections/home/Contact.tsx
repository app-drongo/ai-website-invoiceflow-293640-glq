...
const DEFAULT_CONTACT = {
  ...
  mainDescription:
    'Join thousands of small businesses who trust InvoiceFlow to manage their billing. Get started with a free trial or speak with our team to learn more.',
  ...
  contactSectionTitle: 'Need Help Getting Started?',
  ...
  method2Description: 'Speak with a specialist',
  method2Contact: '+1 (555) 847-3629',
  ...
  office3City: 'Miami, FL',
  office3Address: '800 Brickell Avenue, Suite 900',
  ...
  messagePlaceholder:
    'How many invoices do you send monthly? What challenges are you facing with your current process?',
} as const;
