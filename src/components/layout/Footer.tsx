...
const DEFAULT_FOOTER = {
  ...
  contactAddress: '2847 Financial Plaza, Suite 400, Austin, TX',
  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Webinar Training', href: '/webinars', editableId: 'link-footer-webinars' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Service Agreement', href: '/sla', editableId: 'link-footer-sla' },
      ],
    },
  ];
